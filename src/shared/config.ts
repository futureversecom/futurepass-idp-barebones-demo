...
export const clientId = '16hG72uSGzv8E1lAxXzO9' // getOrThrowFromEnv('CLIENT_ID')
export const accessToken = 'X5tQgDkwN34fmOGg6Q10m_BhhpRFRBfezsDTRHFDTAL' // getOrThrowFromEnv('CLIENT_ACCESS_TOKEN')
export const browserRedirectUri = global.window
  ? global.window.origin + '/callback'
  : '' // not a browser environment so we ignore it

export const identityProviderUri = 'https://shibuya.passonline.cloud' // getOrThrowFromEnv('IDENTITY_PROVIDER_URL')

export const authorizationEndpoint = `${identityProviderUri}/auth`
export const tokenEndpoint = `${identityProviderUri}/token`

export const custodialSignerUrl = 'https://signer.passonline.cloud' // getOrThrowFromEnv('CUSTODIAL_SIGNER_URL')
